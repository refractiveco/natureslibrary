					<div class="project-data-entry-form" data-form-project-id="1">
						<form ng-submit="$parent.submitEntry()">
							<input type="hidden" name="interface" value="<?php echo $interface; ?>" ng-init="$parent.entry.interface='<?php echo $interface; ?>'" ng-model="$parent.entry.interface">
							...
							<div class="row">
								<div class="six columns">
									<p>Complete as many fields as possible before submitting the form. Some information may be missing.</p>
								</div>
							...
							<div class="row">
								<div class="form-button-wrapper">
									<input type="submit" value="Submit entry" class="pink-button">
									<input type="reset" value="Reset form" class="grey-button">
								</div>
							</div>
						</form>
					</div>